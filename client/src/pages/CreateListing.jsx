      ...
      uploadTask.on(
        ...
        async () => {
          ...
          try {
            ...
            const isSafe = moderationResult && moderationResult.nudity.none >= 0.95;
            if (isSafe) {
              resolve(downloadURL);  
            } else {
              reject('Image failed verification due to inappropriate content');
            }
          } catch (error) {
